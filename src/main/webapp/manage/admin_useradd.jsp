                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" type="password"  name="passWord" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>确认密码：</th>
                                <td>
                                    <input class="common-text required" type="password"  name="repassWord" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
