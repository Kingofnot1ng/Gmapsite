...
<body><!------------------------------head------------------------------>
<%@ include file="head.jsp" %><!------------------------------idea------------------------------>
<div class="address mt">
    <div class="wrapper clearfix"><a href="index.jsp" class="fl">首页</a><span>/</span><a href="mygrxx.jsp" class="on">个人信息</a>
    </div>
</div><!------------------------------Bott------------------------------>
<div class="Bott">
...
<div class="bj">
    ...
    <form action="update" method="post">
    	<p><label>账号：</label><input type="text" name="userName" value="${cookie.id.value}" readonly="true"/></p>
    	<p><label>用户名：</label><input type="text" name="name" value="${cookie.name.value}" /></p>
        <p><label>密码：</label><input type="text" name="passWord" value="${cookie.password.value}" /></p>
